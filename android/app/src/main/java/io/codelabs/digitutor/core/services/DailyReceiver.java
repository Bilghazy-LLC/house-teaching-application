package io.codelabs.digitutor.core.services;
...
import io.codelabs.digitutor.view.MainActivity;
...
public class DailyReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        ExtensionUtils.createNotificationChannel(context, "digitutor-channel", "digitutor-channel", message);
        ExtensionUtils.pushNotification(context, context.getString(R.string.notification_title), message, notificationIntent,
                R.mipmap.ic_launcher_round, "digitutor-channel");
